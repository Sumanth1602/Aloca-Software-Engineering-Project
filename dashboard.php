...
<body>
	...
	<header>
        <nav class="nav">
            <div class="logo" style = "position:relative; left:40px; top:-18px;">
                <h1>Aloca</h1>
            </div>
            <div class="nav-upper-options">
            <a href="admin1.php" target="main"  onclick="myFunction(1)">
            ...
            <a href="approved.php" target="main" onclick="myFunction(3)">
            ...
            <a href="deletes.php" target="main" onclick="myFunction(7)">
...
function myFunction(a) {
    // If there's a previously selected option, remove its active class
    if (lastSelected) {
